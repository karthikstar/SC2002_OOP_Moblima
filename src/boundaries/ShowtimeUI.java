...
public class ShowtimeUI {
    public static void printShowtimes(ArrayList<Showtime> showtimeList) {
        ...
        if(showtimeList.size() <= 0) {
            ...
            for(int i = 0; i < showtimeList.size(); i++) {
                ...
                System.out.printf("%d. Cineplex Name: %s, Cinema No: %d\n", showtimeList.get(i).getCineplexName(), showtimeList.get(i).getCinemaNumber());
    ...
    public static void printShowtimeDetails() {
