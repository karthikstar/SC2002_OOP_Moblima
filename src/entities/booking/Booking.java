...
public class Booking implements Serializable {
    ...
    //Constructor
    public Booking(String bookingID, LocalDateTime dateTime, ArrayList<Ticket> ticketsBought, String cineplexName, int cinemaNumber, String movieTitle, Transaction transaction) {
